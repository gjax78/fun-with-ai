const questions = [
  ...
  'Try typing in: "Convert movie titles into emoji: Back to the Future"',
  'Try typing in: "What was Britney Spears\' first song?"',
  'Try typing in: "How many phases of the moon are there?"',
  'Try typing in: "Extract the airport codes from this text: I want to fly from Los Angeles to Miami."',
